...
class FmcwRadar:
    ...
    def generate_S_signal(self, 
        ...
        gain = 1#self.__transmitPower*self.__gain*self.__wavelength**2/( (4*np.pi)**3)
        self.__S_signal = compute_S_signal(self.__S_signal, self.__tx_antennas, self.__rx_antennas, self.__f_IF, self.__f_sampling, self.__N_samples, self.__freqs, self.__phase_diff_TX_RX, gain)
...
@njit
def compute_S_signal(__S_signal, __tx_antennas, __rx_antennas, __f_IF, __f_sampling, __N_samples, __freqs, __phase_diff_TX_RX, __GAIN=1):
